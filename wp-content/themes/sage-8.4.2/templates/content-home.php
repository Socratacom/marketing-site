				...
				<div class="container">
					<div class="row">
						<div class="col-sm-8 col-md-6">
							...
							<ul class="cta-list">
								<li><a href="/solutins" class="btn btn-default outline">View our Solutions <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></li>
	...
	<div class="container">
		<div class="row margin-bottom-30">
			...
			<div class="col-sm-6 col-md-3 match-height margin-bottom-30">
				<p><a href="/solutions/socrata-for-federal-government"><img src="/wp-content/uploads/thumb-federal.jpg" class="img-responsive"></a></p>
