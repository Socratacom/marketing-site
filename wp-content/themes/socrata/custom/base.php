...
add_filter('thesis_body_classes', 'custom_styling');
function custom_styling($classes) {
  if (is_single()) { 
    $classes[] = 'single'; 
  }
  return $classes; 
...
// Remove height and width attributes on blog images
...
// Add img-responsive class to post images
