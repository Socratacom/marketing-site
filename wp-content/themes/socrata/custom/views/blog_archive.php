<div id="content">
  ...
  <section id="blog-layout" class="clearfix masonry" style="width:100% !important;">          
  <script>
    $(function(){
      $('#blog-layout').masonry({
      // options
  ...
  <article class="box">
     ...
     <p style="font-size:.75em; line-height: normal !important;"><small><?php the_taxonomies('post'); ?></small></p>
    </article>
  <?php endwhile; ?>
  <?php endif; ?>
  </section>    
...
<div id="sidebar-one">
  <ul><?php thesis_default_widget('sidebar-1'); ?></ul>
  <h3>From the Newsroom</h3>
  <ul class="blog-feed">
    <?php $my_query = new WP_Query('post_type=news&posts_per_page=5');
