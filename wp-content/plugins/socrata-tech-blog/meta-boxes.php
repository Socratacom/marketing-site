...
// Add the Meta Box
function add_tech_meta_box() {
    add_meta_box(
		'custom_meta_box', // $id
		'Image Attribution', // $title
		'show_tech_meta_box', // $callback
		'tech_blog', // $page
		'side', // $context
		'low'); // $priority
}
add_action('add_meta_boxes', 'add_tech_meta_box');

// Field Array
$prefix = 'custom_';
$custom_tech_meta_fields = array(
	array(
		'label'=> 'Source',
...
// The Callback
function show_tech_meta_box() {
global $custom_tech_meta_fields, $post;
// Use nonce for verification
echo '<input type="hidden" name="custom_meta_box_nonce" value="'.wp_create_nonce(basename(__FILE__)).'" />';
// Begin the field table and loop
echo '<table class="form-table">';
foreach ($custom_tech_meta_fields as $field) {
...
function save_tech_meta($post_id) {
    global $custom_tech_meta_fields;
	// verify nonce
